...
<head>
    ...
    <link rel="stylesheet" href="/css/detailbarang6.css" />
</head>
<body>
    <!-- Header -->
    <header>
...
<section id="products" class="container-fluid py-5 bg-custom">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="card">
                <img src="/image/flannel.png" class="card-img-top" alt="Product 6" />
            </div>
        </div>
...
<div class="col-md-6 d-flex align-items-center">
    <div class="product-description-box p-4">
        ...
        <p class="product-description">
            Tingkatkan koleksi pakaian kasual Anda dengan flannel shirt ini, menambah kehangatan dan gaya pada
            penampilan sehari-hari. Terbuat dari bahan flannel berkualitas tinggi, shirt ini menawarkan kombinasi ideal antara kenyamanan dan 
            daya tarik visual.
        </p>
        <h3 class="product-price">Harga: Rp150.000</h3>
        ...
        <div class="product-subtotal mt-3">
            <h4>Subtotal: <span>Rp150.000</span></h4>
        </div>
