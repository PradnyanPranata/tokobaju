...
<body>
    ...
    <section id="products" class="container py-5">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="card">
                    <img src="/image/sweater.png" class="card-img-top" alt="Product Image" />
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="product-description-box p-4 shadow">
                    <h2 class="product-title">Sweater</h2>
                    <p>Tingkatkan gaya santai Anda dengan sweater ini, memberikan kenyamanan dan kehangatan tanpa mengorbankan penampilan.</p>
                    <h3 class="product-price">Harga: <b>Rp200.000</b></h3>

                    <!-- Form Pembelian -->
                    <form action="{{ route('beli.produk', ['id' => 8]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <!-- Pilih Ukuran -->
                        <div class="mb-3">
