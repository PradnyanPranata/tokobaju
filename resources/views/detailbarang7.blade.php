...
<head>
    ...
    <link rel="stylesheet" href="/css/detailbarang7.css" />
</head>
<body>
    <!-- Header -->
    <header>
...
<section id="products" class="container-fluid py-5 bg-custom">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="card">
                <img src="/image/dress.jpg" class="card-img-top" alt="Product 7" />
            </div>
        </div>
...
<div class="col-md-6 d-flex align-items-center">
    <div class="product-description-box p-4">
        ...
        <p class="product-description">
            Tingkatkan koleksi pakaian santai Anda dengan dress ini, menambah sentuhan elegan dan kenyamanan pada penampilan sehari-hari.
            Terbuat dari bahan berkualitas tinggi, dress ini menawarkan perpaduan sempurna antara gaya dan kepraktisan.
        </p>
        <h3 class="product-price">Harga: Rp300.000</h3>
        ...
        <div class="product-subtotal mt-3">
            <h4>Subtotal: <span>Rp300.000</span></h4>
        </div>
