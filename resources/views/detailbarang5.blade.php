...
<head>
    ...
    <link rel="stylesheet" href="/css/detailbarang5.css" />
</head>
<body>
    <!-- Header -->
    <header>
...
<section id="products" class="container-fluid py-5 bg-custom">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="card">
                <img src="/image/workshirt.png" class="card-img-top" alt="Product 5" />
            </div>
        </div>
...
<div class="col-md-6 d-flex align-items-center">
    <div class="product-description-box p-4">
        ...
        <p class="product-description">
            Tingkatkan penampilan kerja Anda dengan work shirt ini, yang dirancang untuk memberikan kenyamanan dan gaya dalam setiap tugas.
            Terbuat dari bahan yang tahan lama dan mudah dirawat, work shirt ini adalah pilihan ideal untuk lingkungan kerja yang aktif.
        </p>
        <h3 class="product-price">Harga: Rp350.000</h3>
        ...
        <div class="product-subtotal mt-3">
            <h4>Subtotal: <span>Rp350.000</span></h4>
        </div>
