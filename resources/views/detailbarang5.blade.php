...
<body>
    ...
    <section id="products" class="container py-5">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="card">
                    <img src="/image/workshirt.png" class="card-img-top" alt="Product Image" />
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="product-description-box p-4 shadow">
                    ...
                    <p>Tingkatkan penampilan kerja Anda dengan Work Shirt ini, yang dirancang untuk memberikan kenyamanan dan gaya dalam setiap tugas.</p>
                    <h3 class="product-price">Harga: <b>Rp350.000</b></h3>

                    <!-- Form Pembelian -->
                    <form action="{{ route('beli.produk', ['id' => 5]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <!-- Pilih Ukuran -->
                        <div class="mb-3">
