...
<body>
    ...
    <section id="products" class="container py-5">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="card">
                    <img src="/image/cardigan.png" class="card-img-top" alt="Product Image" />
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="product-description-box p-4 shadow">
                    <h2 class="product-title">Cardigan</h2>
                    <p>Cardigan rajutan berkualitas tinggi, nyaman dipakai, dan cocok untuk berbagai acara.</p>
                    <h3 class="product-price">Harga: <b>Rp150.000</b></h3>

                    <!-- Form Pembelian -->
                    <form action="{{ route('beli.produk', ['id' => 1]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <!-- Pilih Ukuran -->
                        <div class="mb-3">
