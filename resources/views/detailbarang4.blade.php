...
<body>
    ...
    <section id="products" class="container py-5">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="card">
                    <img src="/image/hoodie.png" class="card-img-top" alt="Product Image" />
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="product-description-box p-4 shadow">
                    ...
                    <p>Temukan kombinasi sempurna antara kenyamanan dan gaya dengan hoodie ini! Didesain untuk memberi Anda kehangatan dan keleluasaan.</p>
                    <h3 class="product-price">Harga: <b>Rp200.000</b></h3>

                    <!-- Form Pembelian -->
                    <form action="{{ route('beli.produk', ['id' => 4]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <!-- Pilih Ukuran -->
                        <div class="mb-3">
