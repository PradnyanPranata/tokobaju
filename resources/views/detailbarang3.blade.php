...
<head>
    ...
    <link rel="stylesheet" href="/css/detailbarang3.css" />
</head>
<body>
    <!-- Header -->
    <header>
...
<section id="products" class="container-fluid py-5 bg-custom">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="card">
                <img src="/image/blazer.png" class="card-img-top" alt="Product 3" />
            </div>
        </div>
...
<div class="col-md-6 d-flex align-items-center">
    <div class="product-description-box p-4">
        ...
        <p class="product-description">
            Tampil percaya diri dan profesional dengan blazer elegan ini. Didesain untuk memberikan kesan yang rapi dan stylish,
            blazer ini adalah pilihan sempurna untuk berbagai acara, mulai dari pertemuan bisnis hingga pesta malam.
        </p>
        <h3 class="product-price">Harga: Rp500.000</h3>
        ...
        <div class="product-subtotal mt-3">
            <h4>Subtotal: <span>Rp500.000</span></h4>
        </div>
