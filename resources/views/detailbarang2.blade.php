...
<head>
    ...
    <link rel="stylesheet" href="/css/detailbarang2.css" />
</head>
<body>
    <!-- Header -->
    <header>
...
<div class="col-md-6 d-flex align-items-center">
    <div class="product-description-box p-4">
        ...
        <p class="product-description">
            Terbuat dari bahan corduroy berkualitas tinggi, jaket ini menawarkan kenyamanan maksimal sekaligus gaya yang tak lekang oleh waktu.
            Desainnya yang stylish dengan potongan modern cocok untuk berbagai kesempatan, baik santai maupun semi-formal.
        </p>
