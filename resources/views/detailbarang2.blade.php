...
<body>
    ...
    <section id="products" class="container py-5">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="card">
                    <img src="/image/outer.png" class="card-img-top" alt="Product Image" />
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="product-description-box p-4 shadow">
                    <h2 class="product-title">Corduroy Jacket</h2>
                    <p>Terbuat dari bahan corduroy berkualitas tinggi, jaket ini menawarkan kenyamanan maksimal sekaligus gaya yang tak lekang oleh waktu.</p>
                    <h3 class="product-price">Harga: <b>Rp200.000</b></h3>

                    <!-- Form Pembelian -->
                    <form action="{{ route('beli.produk', ['id' => 2]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <!-- Pilih Ukuran -->
                        <div class="mb-3">
